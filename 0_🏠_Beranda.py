...
st.set_page_config(page_title="Trashify Capstone CC26-PSU346", page_icon="♻️", layout="wide")

st.title("♻️ Trashify : Smart Waste Classification & Guide")
st.write("""
Selamat datang di aplikasi **Trashify**.
